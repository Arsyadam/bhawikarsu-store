    ...
    <>
      ...
      >
            ...
            {navLinks.map((link) => {
              ...
              return (
                <Link 
                  ...
                  href={link.href}
                  className={cn(
                    "relative group hover:text-primary transition-colors text-sm tracking-wider uppercase",
        ...
        <div className={cn(
          ...
          isOpen ? "max-h-[400px] opacity-100 p-4" : "max-h-0 opacity-0 p-0"
        )}>
          <div className="flex flex-col gap-4">
            {navLinks.map((link) => {
              ...
              return (
                ...
                >
                  <span className={cn("m-0 uppercase text-sm tracking-wider block", isActive ? "text-primary font-bold" : "font-normal")}>{link.name}</span>
                </Link>
              );
            })}
            <Link 
