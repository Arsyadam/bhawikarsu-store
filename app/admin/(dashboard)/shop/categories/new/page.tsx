...
export default function NewCategoryPage() {
  ...
  const handleImageUpload = async (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    setValue("image", objectUrl); // Using objectUrl just for zod validation if needed, will be replaced on submit
  };
  ...
  return (
    <div className="max-w-4xl mx-auto pb-32">
      <div className="flex items-center gap-6 mb-12">
        ...
        <div>
          <Text as="h1" className="text-6xl font-hand m-0 tracking-normal text-black italic">Initialize Sector</Text>
          <Text className="text-[10px] uppercase font-bold tracking-widest opacity-40">Classification Layer Creation</Text>
        </div>
      </div>
